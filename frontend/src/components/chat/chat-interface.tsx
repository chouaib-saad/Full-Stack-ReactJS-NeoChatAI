...
export function ChatInterface() {
    ...
    const handleClearHistory = async () => {
        try {
            // Call the API to delete history from database
            ...
            // Still clear frontend if API fails (might not be implemented)
            setMessages([])
            toast({
                title: 'History cleared locally',
                description: 'History cleared from view. Some messages may still be stored.',
            })
        }
    }
